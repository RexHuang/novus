...
const WORKLOG_DIR = () => scopedDir(join(homedir(), ".novus"));
const WORKLOG_FILE = () => scopedDir(join(homedir(), ".novus", "session-worklog.json"));
const HISTORY_FILE = () => scopedDir(join(homedir(), ".novus", "session-worklog-history.jsonl"));
const CHECKPOINT_DIR = () => scopedDir(join(homedir(), ".novus", "checkpoints"));
